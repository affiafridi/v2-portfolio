...
function PostRow({ post }: { post: typeof posts[0] }) {
  ...
  return (
    <div ref={wrapRef}>
      ...
      {/* Animated divider — locked to exactly 1px */}
      <div
        ref={dividerRef}
        style={{
          height:    '1px',
      ...
      <Link
        ...
        style={{
          display:             'grid',
          gridTemplateColumns: '100px 1fr clamp(200px, 22vw, 320px)',
      ...
      >
        ...
        {/* Center — title + excerpt + read button */}
        <div>
          <h2
            className="bl-title"
            style={{
          ...
          {/* Read button — brand underline style */}
          <div style={{ display: 'flex', alignItems: 'center', gap: '24px' }}>
            ...
            >
              ...
              <svg width="12" height="8" viewBox="0 0 12 8" fill="none" aria-hidden>
                <path d="M1 4h10M7 1l4 3-4 3" stroke="currentColor" strokeWidth="1.4" strokeLinecap="round" strokeLinejoin="round"/>
              </svg>
            </span>
