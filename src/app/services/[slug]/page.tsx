    ...
    return (
      <div style={{ minHeight: '100vh', display: 'flex', alignItems: 'center', justifyContent: 'center', background: CREAM }}>
        <div style={{ textAlign: 'center' }}>
          <div style={{ fontSize: '11px', letterSpacing: '0.18em', color: `${INK}50`, textTransform: 'uppercase', marginBottom: '16px' }}>404</div>
          <h1 style={{ fontSize: 'clamp(32px,5vw,64px)', fontWeight: 800, color: INK, margin: '0 0 24px', letterSpacing: '-0.03em' }}>Service not found</h1>
          <Link href="/services" style={{ color: ACC, fontSize: '13px', fontWeight: 600 }}>← Back to Services</Link>
        </div>
      </div>
    )
  }
